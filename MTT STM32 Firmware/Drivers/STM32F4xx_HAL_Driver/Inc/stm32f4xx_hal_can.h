...
typedef struct
{
  ...
  uint32_t TimeDISP1;                   /*!< Specifies the number of time quanta in Bit DISPment 1.
                                            This parameter can be a value of @ref CAN_time_quantum_in_bit_DISPment_1 */

  uint32_t TimeDISP2;                   /*!< Specifies the number of time quanta in Bit DISPment 2.
                                            This parameter can be a value of @ref CAN_time_quantum_in_bit_DISPment_2 */
...
/** @defgroup CAN_time_quantum_in_bit_DISPment_1 CAN Time Quantum in Bit DISPment 1
  * @{
  */
...
/** @defgroup CAN_time_quantum_in_bit_DISPment_2 CAN Time Quantum in Bit DISPment 2
  * @{
  */
