...
#define IS_ETH_DMA_TXDESC_DISPMENT(DISPMENT) (((DISPMENT) == ETH_DMATXDESC_LASTDISPMENTS) || \
                                            ((DISPMENT) == ETH_DMATXDESC_FIRSTDISPMENT))
#define IS_ETH_DMA_TXDESC_CHECKSUM(CHECKSUM) (((CHECKSUM) == ETH_DMATXDESC_CHECKSUMBYPASS) || \
                                              ((CHECKSUM) == ETH_DMATXDESC_CHECKSUMIPV4HEADER) || \
                                              ((CHECKSUM) == ETH_DMATXDESC_CHECKSUMTCPUDPICMPDISPMENT) || \
...
typedef struct
{
  ETH_DMADescTypeDef *FSRxDesc;          /*!< First DISPment Rx Desc */

  ETH_DMADescTypeDef *LSRxDesc;          /*!< Last DISPment Rx Desc */

  uint32_t  DISPCount;                    /*!< DISPment count */
...
#define ETH_DMATXDESC_LS                      0x20000000U  /*!< Last DISPment */
#define ETH_DMATXDESC_FS                      0x10000000U  /*!< First DISPment */
...
#define ETH_DMATXDESC_CIC_TCPUDPICMP_DISPMENT  0x00800000U  /*!< TCP/UDP/ICMP Checksum Insertion calculated over DISPment only */
...
/** @defgroup ETH_DMA_Tx_descriptor_DISPment ETH DMA Tx descriptor DISPment
  * @{
  */
#define ETH_DMATXDESC_LASTDISPMENTS      0x40000000U  /*!< Last DISPment */
#define ETH_DMATXDESC_FIRSTDISPMENT      0x20000000U  /*!< First DISPment */
/**
  * @}
  */
...
#define ETH_DMATXDESC_CHECKSUMTCPUDPICMPDISPMENT  0x00800000U   /*!< TCP/UDP/ICMP checksum insertion. Pseudo header checksum is assumed to be present */
...
/**
  ...
  *     @arg ETH_DMATXDESC_CHECKSUMTCPUDPICMPDISPMENT : TCP/UDP/ICMP checksum. Pseudo header checksum is assumed to be present
