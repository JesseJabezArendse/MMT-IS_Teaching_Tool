...
static void MX_TIM7_Init(void)
{
  ...
  htim7.Instance = TIM7;
  htim7.Init.Prescaler = (8400/3/60)-1;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : DISP_GRID0_Pin DISP_GRID1_Pin DISP_GRID2_Pin DISP_DP_Pin */
  GPIO_InitStruct.Pin = DISP_GRID0_Pin|DISP_GRID1_Pin|DISP_GRID2_Pin|DISP_DP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pins : DISP_A_Pin DISP_F_Pin DISP_B_Pin DISP_G_Pin
                           DISP_C_Pin DISP_D_Pin DISP_E_Pin */
  GPIO_InitStruct.Pin = DISP_A_Pin|DISP_F_Pin|DISP_B_Pin|DISP_G_Pin
                          |DISP_C_Pin|DISP_D_Pin|DISP_E_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
