 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Mar 24 21:47:31 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                T208
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                LEDs
#define OUTPUT_0_DIMS_ND               {1,8}
#define OUTPUT_0_NUM_ELEMS             8
#define OUTPUT_0_WIDTH                 1
#define OUTPUT_DIMS_0_COL              8
...
extern void T208_Outputs_wrapper(const boolean_T *Buttons,
  const real_T *Pots,
  boolean_T *LEDs,
...
{
  const boolean_T *Buttons = (boolean_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Pots = (real_T *) ssGetInputPortRealSignal(S, 1);
  boolean_T *LEDs = (boolean_T *) ssGetOutputPortRealSignal(S, 0);
  const int_T u_0_width = ssGetInputPortWidth(S, 0);
  T208_Outputs_wrapper(Buttons, Pots, LEDs, u_0_width, S);
}
