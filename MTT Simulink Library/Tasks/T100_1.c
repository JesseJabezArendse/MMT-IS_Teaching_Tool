 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Mar 13 16:18:24 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                T100_1
...
#define INPUT_0_DIMS_ND                {1,8}
#define INPUT_0_NUM_ELEMS              8
#define INPUT_0_WIDTH                  1
#define INPUT_DIMS_0_COL               8
...
extern void T100_1_Outputs_wrapper(const real_T *Buttons,
  real_T *LEDs);
...
{
  const real_T *Buttons = (real_T *) ssGetInputPortRealSignal(S, 0);
  real_T *LEDs = (real_T *) ssGetOutputPortRealSignal(S, 0);
  T100_1_Outputs_wrapper(Buttons, LEDs);
}
